...
slewMenu.addItem("Horizontal Speed (deg/frame): ", "LatSpeed", 'number', 0, '0.0001');
slewMenu.addItem("Vertical Speed (ft/frame): ", "VertSpeed", 'number', 0, '2');
slewMenu.addItem("Rotation Increment (degs): ", "RotAmount", 'number', 0, '2');
...
slewMenu.addSubHeading("Keybinds");
...
slewMenu.addSubHeading("Rotation");
