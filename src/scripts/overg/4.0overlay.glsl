...
// Declare output variable (replaces gl_FragColor)
out vec4 fragColor;
...
const float MAX_VIGNETTE_R    = 1.6;  // radius (screen-space, aspect corrected) where closure begins
...
void main() {
    ...
    fragColor = vec4(finalColor, srcColor.a);
}